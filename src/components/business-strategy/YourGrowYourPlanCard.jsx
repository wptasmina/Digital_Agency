...
export default function YourGrowYourPlanCard({ plan }) {
  const { planName, pricePerMonth, period, features } = plan;

  return (
    <div className="p-6 sm:p-8 lg:p-10 hover:-mt-4 sm:hover:-mt-5 lg:hover:-mt-6 group bg-white transition-all duration-500 cursor-pointer">
