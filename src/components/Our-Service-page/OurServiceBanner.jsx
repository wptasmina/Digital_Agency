...
import bgImage from '../../assets/digitalAgency/image/our-service/service-banner.jpg';
          ...
          <div className="max-w-6xl mx-auto lg:mt-20 mt-10">
            ...
            <div className="grid md:grid-cols-2 md:gap-16 gap-8 mb-8">
              <div className="space-y-4">
                <h2 className="text-sm md:text-5xl">Our Services</h2>
            ...
            <div className="w-full">
              <img src={bgImage} alt="image" className="w-full h-auto object-cover" />
            </div>
          </div>
      </section>
  )
