...
export default function ContactUsPage() {
  return (
    <section className="Container bg-[#F9FBFF] ">
      <div className="max-w-6xl mx-auto md:pt-10 pt-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center sm:gap-8 lg:gap-8">
          {/* LEFT :: FORM */}
          ...
          <div className="space-y-3 sm:space-y-4 order-1 md:order-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[13px] text-[#19324D] font-normal uppercase">
                CONTACT US
              </span>
            </div>

            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-normal text-gray-600 leading-tight">
              Let&apos;s Create <br className="hidden sm:block" />
              <span className="text-[#19324D] font-semibold">Something Amazing!</span>
            </h2>
