...
export default function Faq({ reverseLayout = false }) {
...
// Usage Example
// <Faq reverseLayout={true} />   // Left and Right swap হবে
// <Faq />                       // Default layout
...
//           {/* Left Column *//* TOP HEADING */}
//         <div className="flex flex-col space-y-4">
//             {/* About Us" */}
//            <FeaturesList  
//               badge = "Frequently Ask Question"
//               title={
//               <>Answers to Common <Highlight className="text-[#19324d] font-semibold"> Questions About Our Services
//                </Highlight>
//                </>
//               }   
//               subtitle='Have questions about how we work, our process, or what to expect? We’ve got you covered. This section answers the most common questions our clients ask — from project timelines and pricing to strategy and results — so you can feel confident before we begin your journey toward growth.'
...
//             {/* Botton*/}
//           <div className="flex">
//             <Button title="Read More" className="" />
//           </div>
